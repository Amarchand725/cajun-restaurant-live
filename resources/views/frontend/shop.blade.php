            ...
            <div class="max-w-6xl mx-auto  2xl:px-0 lg:px-4 px-3">
                ...
                <div class="grid grid-cols-12 items-center lg:gap-8 gap-5 lg:pt-8 pt-5" id="mobile" role="tab"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/shop-tab-1.jpg')}}" alt="">
                            </div>
                            <div
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/shop-tab-2.jpg')}}" alt="" class="">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/tab-3.jpg')}}" alt="" class="">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/tab-4.jpg')}}" alt="" class="">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/tab-5.jpg')}}" alt="" class="">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/tab-6.jpg')}}" alt="" class="">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/tab-7.jpg')}}" alt="" class="">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/tab-8.jpg')}}" alt="" class="w-full">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
                ...
                <div class="grid grid-cols-12 items-center lg:gap-8 gap-5 lg:pt-8 pt-5" id="non" role="tab"
                    ...
                    <div class="lg:col-span-4 md:col-span-6 col-span-12">
                        <div class="relative group overflow-hidden">
                            <div class="mx-auto">
                                <img src="{{url('public/frontend/img/tab-9.jpg')}}" alt="" class="">
                            </div>
                            <div
                                class="absolute bottom-[-50px] left-[100px] p-4 group-hover:opacity-100 opacity-0 group-hover:bottom-[-6%] w-full transition-all ease-in-out duration-700 ">
                                <a href="javascript:;"
