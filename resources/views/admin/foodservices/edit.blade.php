        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" >
                ...
                <div class="content-header-right mt-3">
                    <a href="{{ route('foodservice.index') }}" title="All Admin.foodservices" class="btn btn-primary btn-sm">View All</a>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route("foodservice.update", $model->id) }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf
                    {{ method_field('PATCH') }}
