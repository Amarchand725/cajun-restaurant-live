                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            @can('foodservice-create')
                                <a href="{{ route('foodservice.create') }}" class="btn btn-sm fw-bold btn-primary">Add New Foodservice</a>
                            @endcan
                            <a href="{{ route('admin.foodservice.trash.records') }}" title="{{ $page_title }} Trash Records" class="btn btn-sm fw-bold btn-primary">Restore</a>
