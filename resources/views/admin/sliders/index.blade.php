                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            @can('slider-create')
                                <a href="{{ route('slider.create') }}" class="btn btn-sm fw-bold btn-primary">Add New Slider</a>
                            @endcan
                            <a href="{{ route('admin.slider.trash.records') }}" title="{{ $page_title }} Trash Records" class="btn btn-sm fw-bold btn-primary">Restore</a>
                            ...
                            <div class="card-body pt-6">
                                ...
                                <table  class="table align-middle table-row-dashed fs-6 gy-5" id="audit-log-table">
                                    <thead>
                                        <tr>
                                            <th>SL</th>
                                            <th>TITLE</th><th>SUB_TITLE</th><th>IMAGE</th><th>STATUS</th>
                                            <th>Action</th>
                                        </tr>
                                    </thead>
                                    <tbody id="body">
                                        @foreach($models as $key=>$model)
                                            <tr id="id-{{ $model->id }}">
                                                ...
                                                <td>{!! $model->title !!}</td><td>{!! $model->sub_title !!}</td><td>@if($model->image)<img style="border-radius: 50%;" src="{{ asset("public/admin/images/sliders") }}/{{ $model->image }}" width="50px" height="50px" alt="">@else<img style="border-radius: 50%;" src="{{ asset("public/default.png") }}" width="50px" height="50px" alt="">@endif</td><td>@if($model->status)<span class="badge badge-success">Active</span>@else<span class="badge badge-danger">In-Active</span>@endif</td><td width="250px"><a href="{{ route("slider.show", $model->id) }}" data-toggle="tooltip" data-placement="top" title="Show Slider" class="btn btn-info btn-sm"><i class="fa fa-eye"></i></a><a href="{{ route("slider.edit", $model->id) }}" data-toggle="tooltip" data-placement="top" title="Edit Slider" class="btn btn-primary btn-sm" style="margin-left: 3px;"><i class="fa fa-edit"></i></a><button data-toggle="tooltip" data-placement="top" title="Delete Slider" class="btn btn-danger btn-sm delete" data-slug="{{ $model->id }}" data-del-url="{{ route("slider.destroy", $model->id) }}" style="margin-left: 3px;"><i class="fa fa-trash"></i></button></td>
                                            </tr>
                                        @endforeach
                                        <tr>
                                            <td colspan="9">
