        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" >
                ...
                <div class="content-header-right mt-3">
                    <a href="{{ route('slider.index') }}" title="All Admin.sliders" class="btn btn-primary btn-sm">View All</a>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
