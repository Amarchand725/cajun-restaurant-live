            ...
            <div id="" class="collapse show">
                ...
                <form action="{{ route("slider.store") }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    ...
                    <div class="card-body border-top p-9">
                        ...
                        <div class="row mb-6">
                        <label for="sub_title" class="col-lg-2 col-form-label required fw-bold fs-6">Sub_title</label><div class="col-lg-8 fv-row"><input type="text" class="form-control form-control-lg form-control-solid" name="sub_title" value="{{ old("sub_title") }}" placeholder="Enter sub_title">
