    ...
    <div class="app-navbar flex-shrink-0">
        ...
        <div class="app-navbar-item ms-1 ms-lg-3">
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true">
                <!--begin::Heading-->
                <div class="d-flex flex-column bgi-no-repeat rounded-top" style="background-image:url('{{ asset('public/admin') }}/media/misc/pattern-1.jpg')">
                    <!--begin::Title-->
                    ...
                    <div class="tab-pane fade show active" id="kt_topbar_notifications_1" role="tabpanel">
                            ...
                            @foreach (auth()->user()->unreadnotifications as $notification)
                                <div class="d-flex flex-stack py-4">
                                    ...
                                    <div class="d-flex align-items-center">
                                        ...
                                        <!--begin::Title-->
                                        <div class="mb-0 me-2">
                                            <a href="{{ route('admin.markasread', $notification->id) }}" class="fs-6 text-gray-800 text-hover-primary fw-bold">{{ $notification->data['name'] }}</a>
                                            <div class="text-gray-400 fs-7">{{ $notification->data['email'] }}</div>
                                        </div>
                                        <!--end::Title-->
                                    </div>
                                    <!--end::Section-->
                                    <!--begin::Label-->
                                    <span class="badge badge-light fs-8">{{ $notification->updated_at->diffForHumans(); }}</span>
                                    <!--end::Label-->
                                </div>
                            @endforeach
                            <!--end::Item-->
                        ...
                        @if(count(auth()->user()->unreadnotifications))
                            <div class="py-3 text-center border-top">
                                <a href="{{ route('admin.view.all.notifications') }}" class="btn btn-color-gray-600 btn-active-color-primary">View All
        ...
        <div class="app-navbar-item ms-1 ms-lg-3" id="kt_header_user_menu_toggle">
            ...
            @if(!empty(Auth::user()->hasProfile->avatar))
                @php
            ...
            <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                ...
                <!--begin::Menu item-->
                <div class="menu-item px-5">
                    <a class="button-ajax menu-link px-5" title="Logout" href="{{ route('admin.logout') }}"
