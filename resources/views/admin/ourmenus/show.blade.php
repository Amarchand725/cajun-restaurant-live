...
@section('content')
<input type="hidden" id="page_url" value="{{ route('ourmenu.index') }}">
                ...
                <div id="kt_app_toolbar" class="app-toolbar mt-5 py-3 py-lg-6">
                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="d-flex align-items-center gap-2 gap-lg-3">
                            ...
                            @can('ourmenu-list')
                                <a href="{{ route('ourmenu.index') }}" title="All ourmenu" class="btn btn-sm fw-bold btn-primary">View All</a>
                            @endcan
                        </div>
                        <!--end::Actions-->
                    </div>
