    ...
    <div id="kt_app_content_container" class="app-container ">
        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div id="" class="collapse show">
                <!--begin::Form-->
                <form action="{{ route("ourmenu.store") }}" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    @csrf

                    <div class="card-body border-top p-9">
                        <div class="row mb-6">
                            <label for="category" class="col-lg-2 col-form-label required fw-bold fs-6">Menu Category</label>
                            <div class="col-lg-8 fv-row">
                                <select class="selectpicker" name="menu_category_id" data-live-search="true">
                                    <option value="" selected>Select menu category</option>
                                    @foreach ($menu_categories as $category)
                                        <option value="{{ $category->id }}" {{ old('menu_category_id')==$category->id?'selected':'' }}>{{ $category->title }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="row mb-6">
                            <label for="title" class="col-lg-2 col-form-label required fw-bold fs-6">Title</label>
                            <div class="col-lg-8 fv-row">
                                <input type="text" class="form-control form-control-lg form-control-solid" name="title" value="{{ old("title") }}" placeholder="Enter title">
