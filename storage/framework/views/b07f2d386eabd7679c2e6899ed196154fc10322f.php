<header class="pb-4 relative z-10 w-full border-b-2 border-white">
    <nav class="">
        ...
        <div class="block md:hidden">
            <div class="block lg:hidden xl:px-0 lg:px-3 px-4" x-data="{ open: false }">
                <div class="grid items-center grid-cols-12 sm:gap-5 gap-3 place-self-center sm:py-3 pt-3 ">
                    ...
                    <div class="col-span-1">
                        <div class="flex flex-col">
                            ...
                            <div id="mobile-menu"
                                class="flex-col hidden flex-grow pb-4 md:pb-0 p-5 absolute top-[40%] left-0 bg-[#fff] drop-shadow-md w-full z-50 py-5 xl:px-2 mt-10 ">
                                <ul class="">
