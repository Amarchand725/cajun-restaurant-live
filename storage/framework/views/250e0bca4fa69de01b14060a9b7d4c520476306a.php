            ...
            <div class="">
                <div class="grid grid-cols-12">
                    <div class="col-span-12">
                        <div class="bg-[url('public/admin/images/sliders/<?php echo e($slider->image); ?>')] bg-cover bg-center h-[100vh] relative z-[1] flex items-center justify-center">
...
<?php /**PATH C:\wamp64\www\cajun-restaurant\resources\views/frontend/layouts/slider.blade.php ENDPATH**/ ?>