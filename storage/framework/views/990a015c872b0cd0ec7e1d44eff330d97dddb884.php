...
<?php $__env->startSection('content'); ?>
    ...
    <section class="md:mt-[-100px]">
        <div
            class="bg-[url('frontend/img/product-bg.jpg')] bg-cover h-[100vh] bg-no-repeat before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-[#00066] before:z-[0] relative w-full flex flex-col items-center justify-center py-10">
            <div class="txt">
    ...
    <section class="">
        <div class="tabs lg:py-[100px] py-10">
            <div class="max-w-6xl mx-auto  2xl:px-0 lg:px-4 px-3">
                <div class="">  
                    <ul class="flex flex-warp justify-center gap-x-3 lg:gap-x-7" id="myTab5" data-tabs-toggle="#meeTab3Content">
                        <li class="group">
