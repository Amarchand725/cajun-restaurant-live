                ...
                <div class="grid grid-cols-12 items-center">
                    <div class="col-span-2 xl:col-span-3">
                        <div class="logo">
                            <a href="<?php echo e(route('home')); ?>">
                                <img loading="lazy" src="<?php echo e(asset('public/frontend')); ?>/img/logo-light.png" height="46" width="196" alt="" />
                            </a>
                        </div>
                    </div>
                    <div class="col-span-10 xl:col-span-9">
                        <ul class="flex flex-col sm:flex-row items-center justify-end gap-x-2 lg:gap-x-4 xl:gap-x-7">
                            ...
                            <li class="relative group">
                                <div>
                                    <a href="<?php echo e(route('gallery')); ?>" class="text-[13px] lg:text-[16px] font-[600] tracking-[0.6px]">
                                        <span class="text-white hover:text-[#d3a971] uppercase">
                                        Gallery
                                        </span>
                                    </a>
                            ...
                            <li class="relative group">
                                <div>
                                    <a href="<?php echo e(route('blog')); ?>" class="text-[13px] lg:text-[16px] font-[600] tracking-[0.6px]">
                                        <span class="text-white hover:text-[#d3a971] uppercase">
                                        Blog
                                        </span>
                                    </a>
                            ...
                            <li class="relative group">
                                <div>
                                    <a href="<?php echo e(route('shop')); ?>" class="text-[13px] lg:text-[16px] font-[600] tracking-[0.6px]">
                                        <span class="text-white hover:text-[#d3a971] uppercase">
                                        Shop
                                        </span>
                                    </a>
                            ...
                            <li class="">
                                <a href="<?php echo e(route('reservation')); ?>" class="border-white border-2 min-w-[129px] h-[40px] leading-[35px] text-center block text-[13px] lg:text-[16px] font-[600] tracking-[0.6px]">
                    ...
                    <div class="col-span-11">
                        <div class="md:col-span-3 col-span-12">
                            <div class="world-logo">
                                <img class="inline w-[250px] h-[45px]" src="<?php echo e(asset('public/frontend/logo.png')); ?>" alt="...">
                            </div>
                        </div>
                    </div>
