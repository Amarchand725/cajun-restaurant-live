        ...
        <div class="card mb-5 mb-xl-10">
            ...
            <div class="card-header border-0 cursor-pointer" role="button" >
                ...
                <div class="content-header-right mt-3">
                    <a href="<?php echo e(route('menucategory.index')); ?>" title="All Admin.menucategories" class="btn btn-primary btn-sm">View All</a>
                </div>
                <!--end::Card title-->
            </div>
            <!--begin::Card header-->
            ...
            <div id="" class="collapse show">
                <!--begin::Form-->
                <form action="<?php echo e(route("menucategory.update", $model->id)); ?>" id="regform" class="form-horizontal" enctype="multipart/form-data" method="post" accept-charset="utf-8">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cajun-restaurant\resources\views/Admin/menucategories/edit.blade.php ENDPATH**/ ?>