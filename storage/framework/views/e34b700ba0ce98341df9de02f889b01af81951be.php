            ...
            <div class="grid grid-cols-12 gap-x-8">
                <div class="col-span-5">
                    <div class="card relative">
                        <img src="<?php echo e(url('public/frontend/img/card-bg.jpg')); ?>" alt="Card"
                    ...
                    <div class="col-span-12">
                        <div class="award-slider">
                            <div class="sm:mx-0 mx-2">
                                <img src="<?php echo e(url('public/frontend/img/slider-6.png')); ?>" alt="" class="">
                            </div>
                            <div class="sm:mx-0 mx-2">
                                <img src="<?php echo e(url('public/frontend/img/slider-5.png')); ?>" alt="" class="">
                            </div>
                            <div class="sm:mx-0 mx-2">
                                <img src="<?php echo e(url('public/frontend/img/slider-4.png')); ?>" alt="" class="">
                            </div>
                            <div class="sm:mx-0 mx-2">
                                <img src="<?php echo e(url('public/frontend/img/slider-3.png')); ?>" alt="" class="">
                            </div>
                            <div class="sm:mx-0 mx-2">
                                <img src="<?php echo e(url('public/frontend/img/slider-1.png')); ?>" alt="" class="">
                            </div>
                            <div class="sm:mx-0 mx-2">
                                <img src="<?php echo e(url('public/frontend/img/slider-2.png')); ?>" alt="" class="">
                            </div>
                            <div class="sm:mx-0 mx-2">
                                <img src="<?php echo e(url('public/frontend/img/slider-6.png')); ?>" alt="" class="">
                            </div>
...
<?php echo $__env->make("frontend.layouts.app", \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cajun-restaurant\resources\views/frontend/reservation.blade.php ENDPATH**/ ?>