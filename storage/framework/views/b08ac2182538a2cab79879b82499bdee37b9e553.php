<footer class="bg-[#222] py-[40px] sm:py-[100px]">
    <div class="max-w-7xl mx-auto xl:px-0 lg:px-3 px-4">
        <div class="grid grid-cols-12 gap-y-7 items-center">
            ...
            <div class="col-span-12 lg:col-span-4">
                <div class="txt text-center">
                <img src="<?php echo e(url('frontend/img/cajun-logo-black.png')); ?>" alt="LOGO" class="mx-auto mb-6 w-2/12 lg:w-4/12" />
...
<?php /**PATH C:\xampp\htdocs\cajun-restaurant-live\resources\views/frontend/layouts/footer.blade.php ENDPATH**/ ?>