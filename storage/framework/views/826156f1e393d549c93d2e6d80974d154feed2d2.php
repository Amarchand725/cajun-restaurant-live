<?php $__env->startSection('content'); ?>
            ...
            <div class="grid grid-cols-12 gap-x-10">
                ...
                <div class="col-span-12 md:col-span-4 mb-[30px]">
                    <div class="card relative overflow-hidden z-0 group">
                        <div
                            ...
                            <img src="<?php echo e(asset('public/frontend')); ?>/img/card1.jpg" alt="Card"
                ...
                <div class="col-span-12 md:col-span-4 mb-[30px]">
                    <div class="card relative overflow-hidden z-0 group">
                        <div
                            class="img before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-[#00000066] before:z-[1]">
                            <img src="<?php echo e(asset('public/frontend')); ?>/img/card2.jpg" alt="Card"
                                class="group-hover:scale-[1.1] duration-700 group-hover:duration-700">
                        </div>
                        <div class="txt">
                            <p
                ...
                <div class="col-span-12 md:col-span-4 mb-[30px]">
                    <div class="card relative overflow-hidden z-0 group">
                        <div
                            class="img before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-[#00000066] before:z-[1]">
                            <img src="<?php echo e(asset('public/frontend')); ?>/img/card3.jpg" alt="Card"
                                class="group-hover:scale-[1.1] duration-700 group-hover:duration-700">
                        </div>
                        <div class="txt">
                            <p
    ...
    <!-- People talk start-->
    <?php echo $__env->make('frontend.layouts.testimonial', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!-- People talk end-->
