            ...
            <div class="grid grid-cols-12 gap-x-10">
                <div class="col-span-12">
                    <div class="txt text-center mb-20">
                        <p class="text-[40px] xl:text-[50px] text-[#d3a971] block mb-[8px] leading-[1] kristi">
                            Welcome To The El Royale
                        </p>
                        <h1 class="text-[45px] font-[400] mb-[10px] yeseva lg:w-9/12 mx-auto leading-[1.2] text-[#282828] mb-[30px]">
                            Delicious Food, Friendly Staff, Cozy Atmosphere & Positive Emotions!
                        </h1>
                        <img src="<?php echo e(asset('public/frontend')); ?>/img/shape2.png" alt="Shape" class="mx-auto">
                    </div>
                </div>
                    ...
                    <div class="col-span-12 md:col-span-4 mb-[30px]">
                        <div class="card relative overflow-hidden z-0 group">
                            <div class="img before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-[#00000066] before:z-[1]">
                                <img src="<?php echo e(asset('public/admin/images/foodservices')); ?>/<?php echo e($food_service->image); ?>" alt="Card" class="group-hover:scale-[1.1] duration-700 group-hover:duration-700">
                            </div>
                            <div class="txt">
                ...
                <div class="col-span-12">
                    <div class="txt text-center">
                        <p class="text-[14px] sm:text-[17px] lg:text-[19px] leading-[32px] mb-[15px] text-[#9b9b9b] w-7/12 xl:pr-4 mx-auto">
            ...
            <div class="grid grid-cols-12">
                <div class="col-span-12">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-x-4 relative z-[99999]">
                        <img src="<?php echo e(asset('public/frontend')); ?>/img/signature2.png" alt="Signature" class="">
                        <div class="btn">
                            <a href="javascript:;"
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\cajun-restaurant\resources\views/frontend/index.blade.php ENDPATH**/ ?>