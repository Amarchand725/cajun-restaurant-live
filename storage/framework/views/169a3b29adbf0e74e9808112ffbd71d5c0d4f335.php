...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(url('frontend/css/fancybox.min.css')); ?>" rel="stylesheet">
        <script src="<?php echo e(url('frontend/css/tailwindcsss-3.3.0.css')); ?>"></script>
    ...
    <body class="antialiased">
        ...
        <script src="<?php echo e(url('frontend/js/slick.js')); ?>"></script>
        ...
        <button id="scrollTops" class="lg:block hidden actived fixed right-[30px] bottom-[30px] w-[50px] h-[50px] z-[10000] text-[20px] rounded-[3px] text-white bg-[#d3a971]">
...
<?php /**PATH C:\xampp\htdocs\cajun-restaurant-live\resources\views/frontend/layouts/app.blade.php ENDPATH**/ ?>