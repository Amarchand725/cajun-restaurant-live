...
<?php $__env->startSection('content'); ?>
    ...
    <section class="md:mt-[-100px]">
        <div
            class="bg-[url('frontend/img/reservation-bg.jpg')] bg-cover h-[100vh] bg-no-repeat before:content-[''] before:absolute before:left-0 before:top-0 before:w-full before:h-full before:bg-[#00066] before:z-[0] relative w-full flex flex-col items-center justify-center py-10">
            <div class="txt">
            <h4 class="relative z-[999999] md:pt-[110px] kristi text-center lg:text-[45px] md:text-[35px] text-[30px] text-[#f9f9f9] ">
            Book A Table
            </h4>
            <h1
    ...
    <section class="lg:mt-[-100px]">
        <div class="max-w-7xl mx-auto bg-white p-[20px] sm:p-[40px] lg:p-[90px] rounded-[4px] relative z-[9999] shadow-md">
            <div class="grid grid-cols-12 gap-y-8 sm:gap-x-8">
                <div class="col-span-12 sm:col-span-5">
                    <div class="card relative">
                        ...
                        <div class="txt text-center pt-[75px] px-[50px] sm:px-[25px] lg:px-[50px] pb-[70px] relative z-[99999]">
                            ...
                            <h5 class="text-[25px] md:text-[30px] xl:text-[34px] text-white font-[600] leading-[1.2] mb-[8px] yeseva">
                                Opening Times</h5>
                            <ul class="mb-[32px]">
                                <li
                                    class="flex items-center justify-between leading-[40px] xl:leading-[50px] pt-[6px] border-b-[1px] border-dashed border-[#494b4f]">
                                    <span class="leading-[40px] text-[#9b9b9b] text-[15px] md:text-[17px] font-[400]">Week days</span>
                                    <span class="leading-[40px] text-[#9b9b9b] text-[15px] md:text-[17px] font-[400]">09.00 – 24:00</span>
                                </li>
                                <li
                                    class="flex items-center justify-between leading-[40px] xl:leading-[50px] pt-[6px] border-b-[1px] border-dashed border-[#494b4f]">
                                    <span class="leading-[40px] text-[#9b9b9b] text-[15px] md:text-[17px] font-[400]">Saturday</span>
                                    <span class="leading-[40px] text-[#9b9b9b] text-[15px] md:text-[17px] font-[400]">08:00 – 03.00</span>
                                </li>
                                <li class="flex items-center justify-between leading-[40px] xl:leading-[50px] pt-[6px]">
                                    <span class="leading-[40px] text-[#9b9b9b] text-[15px] md:text-[17px] font-[400]">Saturday</span>
                                    <span class="leading-[40px] text-[#9b9b9b] text-[15px] md:text-[17px] font-[400]">Day off</span>
                                </li>
                            </ul>
                            <div class="call">
                                <span class="text-[25px] md:text-[35px] text-[#d3a971] kristi block leading-[1.5]">Call Us Now</span>
                                <a href="tel:;"
                                    class="text-white text-[20px] md:text-[24px] lg:text-[32px] font-[400] block yeseva mb-[6px] xl:mb-[45px] leading-[1.2]">
                                    0201023456789
                                </a>
                            </div>
                        </div>
                ...
                <div class="col-span-12 sm:col-span-7">
                    <div
                        class="form border-[#d3a971] border rounded-[2px] bg-white pt-[30px] lg:pt-[50px] pb-[60px] relative px-[25px] lg:px-[38px] before:content-[''] before:absolute before:top-[-4px] before:right-[2px] before:left-[3px] before:bottom-0 before:h-full before:rounded-[2px] before:border before:border-[#d3a971] before:z-[0]">
                        <p
                        ...
                        <div class="grid grid-cols-12 md:gap-x-7 gap-y-7 relative z-[99999] ">
                            <div class="col-span-12 md:ol-span-6">
                                <div
    ...
    <section class="">
        <div class="discover-menu lg:py-[100px] py-10">
            ...
            <div class="flex md:flex-row flex-col md:gap-x-14 justify-center lg:pt-12 pt-5 2xl:px-0 lg:px-4 px-3">
                <ul class=" md:text-right md:pb-0 pb-5 pt-[20px] sm:pt-0">
                    <li class=" ml-5 sm:text-[14px] text-[12px] lg:text-[16px] font-[400] text-[#9b9b9b] mb-[7px] after:content-[''] after:absolute after:bg-[#d3a971] after:rounded-[50%] after:w-[8px] after:h-[8px] after:right-[102%] xl:after:right-[-17px] after:top-[22%] relative">
