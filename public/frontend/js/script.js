...
/******/ (() => {
    ...
    var Default = {
        alwaysOpen: false,
        activeClasses: "text-[#d3a971]",
        inactiveClasses: "text-[#222]",
    ...
    /* harmony default export */ const collapse = Collapse; // CONCATENATED MODULE: ./node_modules/@popperjs/core/lib/dom-utils/getWindow.js
...
*/
    ...
    /* harmony default export */ const dropdown = Dropdown; // CONCATENATED MODULE: ./src/components/tabs.js
                    ...
                    if (this._items.length) {
                        ...
                        this._items.map(function (tab) {
                            tab.triggerEl.addEventListener(
                                ...
                                function () {
                                    _this.show(tab.id);
                                    $(".trusted-slider").slick("refresh");
                                    $(".ltrslider").slick("refresh");
                                    $(".ltrslider").slick("refresh");
                                    $(".ethslider2").slick("refresh");
                                    $(".testimonial-slider").slick("refresh");
                                    $(".ethslider1").slick("refresh");
                                    $(".footer-slider").slick("refresh");
                                    $(".client-slider-resp").slick("refresh");
                                    $(".client-slider").slick("refresh");
                                }
                            );
                        });
                    }
    ...
    /* harmony default export */ const tabs = Tabs; // CONCATENATED MODULE: ./src/flowbite.js
...
//     $(".client-slider-resp").slick("slickPrev");
// });
// $(".slick-next").click(function () {
//     $(".client-slider-resp").slick("slickNext");
// });

// $(".client-slider-resp").slick({
//     speed: "1000",
//     //   autoplay: true,
//     slidesToShow: 2,
//     slidesToScroll: 1,
...
// $.noConflict();
var phone = document.getElementsByClassName("phone-texted");
for (i = 0; i < phone.length; i++) {
    window.intlTelInput(phone[i], {
        setCountry: "En",
        nationalMode: false,
        ...
        customPlaceholder: function (selectedCountryPlaceholder) {
            return "Phone / Mobile e.g. " + selectedCountryPlaceholder;
        },
    });
}
...
$("#search-filter").on("keyup", function () {
    ...
    $("#table-filter li").filter(function () {
        $(this).toggle($(this).text().toLowerCase().indexOf(value) > -1);
    });
});
